...
class TestConfig(unittest.TestCase):
    ...
    def test_get_non_existing_keys(self):
        ...
        self.assertRaises(KeyError, config.get, 'foo', 'bar')
    ...
    def test_get_dict_non_existing_keys(self):
        ...
        self.assertRaises(KeyError, config.get, 'bar')

    def test_get_with_default(self):
        config = Config()

        self.assertRaises(KeyError, config.get, 'foo', 'bar', 'ooops')
        self.assertRaises(KeyError, config.get, 'foo', 'doo', 'wooo')
    ...
    def test_setdefault(self):
        ...
        self.assertRaises(KeyError, config.get, 'foo')
...
class TestLoadConfig(unittest.TestCase):
    ...
    def test_default_config(self):
        ...
        self.assertEqual(config.get('resources.template', 'templates_dir'), template_config['templates_dir'])
        self.assertEqual(config.get('resources.i18n', 'locale'), i18n_config['locale'])
        self.assertEqual(config.get('resources.i18n', 'timezone'), i18n_config['timezone'])
    ...
    def test_default_config_with_non_existing_key(self):
        ...
        self.assertEqual(config.get('resources.i18n', 'i_dont_exist', 'foo'), 'foo')
    ...
    def test_override_config(self):
        ...
        self.assertEqual(config.get('resources.template', 'templates_dir'), 'apps/templates')
        self.assertEqual(config.get('resources.i18n', 'locale'), 'pt_BR')
        self.assertEqual(config.get('resources.i18n', 'timezone'), 'America/Sao_Paulo')
    ...
    def test_override_config2(self):
        ...
        self.assertEqual(config.get('resources.i18n', 'locale'), 'en_US')
        self.assertEqual(config.get('resources.i18n', 'timezone'), 'America/Sao_Paulo')
    ...
    def test_get_with_default(self):
        ...
        self.assertEqual(config.get('resources.i18n', 'bar', 'baz'), 'baz')
    ...
    def test_get_with_default_and_module_load(self):
        config = Config()
        self.assertEqual(config.get('resources.i18n', 'locale'), 'en_US')
        self.assertEqual(config.get('resources.i18n', 'locale', 'foo'), 'en_US')

    def test_required_config(self):
        config = Config()
        self.assertRaises(KeyError, config.get, 'resources.i18n', 'foo')

    def test_missing_module(self):
        config = Config()
        self.assertRaises(KeyError, config.get, 'i_dont_exist', 'i_dont_exist')

    def test_missing_module2(self):
        config = Config()
        self.assertRaises(KeyError, config.get, 'i_dont_exist')

    def test_missing_key(self):
        config = Config()
        self.assertRaises(KeyError, config.get, 'resources.i18n', 'i_dont_exist')

    def test_missing_default_config(self):
        config = Config()
        self.assertRaises(KeyError, config.get, 'tipfy', 'foo')
